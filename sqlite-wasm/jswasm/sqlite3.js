...
** SQLITE_SOURCE_ID "2024-07-21 23:10:55 2c122026db979a099a3d1a14ae1e01a0a64a559905ea414b2d80ed7dc3e04846"
**
** Using the Emscripten SDK version 3.1.63.
*/
...
globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3){
  sqlite3.version = {"libVersion": "3.47.0", "libVersionNumber": 3047000, "sourceId": "2024-07-21 23:10:55 2c122026db979a099a3d1a14ae1e01a0a64a559905ea414b2d80ed7dc3e04846","downloadVersion": 3470000};
});
...
sqlite3.installOpfsVfs = function callee(options){
...
sqlite3.installOpfsVfs.defaultProxyUri =
  "sqlite3-opfs-async-proxy.js";
globalThis.sqlite3ApiBootstrap.initializersAsync.push(async (sqlite3)=>{
  try{
    let proxyJs = sqlite3.installOpfsVfs.defaultProxyUri;
    if(sqlite3.scriptInfo.sqlite3Dir){
      sqlite3.installOpfsVfs.defaultProxyUri =
        sqlite3.scriptInfo.sqlite3Dir + proxyJs;
      
    }
    return sqlite3.installOpfsVfs().catch((e)=>{
